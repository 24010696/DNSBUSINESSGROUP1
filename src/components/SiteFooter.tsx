...
const prefillSubject = encodeURIComponent("Enquiry from Website");
const prefillBody = encodeURIComponent("Hello DNS Business Group,\n\nI would like to enquire about your services.\n\nThank you.");
const emailHref = `mailto:${SITE.email}?subject=${prefillSubject}&body=${prefillBody}`;
      ...
      <div className="container-prose grid gap-12 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <img src={logo} alt="DNS Business Group" width={44} height={44} className="h-11 w-11 object-contain" />
        ...
        <div>
          <h4 className="font-display text-sm font-semibold uppercase tracking-wider text-white">Divisions</h4>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            ...
            <li className="flex items-start gap-2.5">
              ...
              <a href={emailHref} className="text-white/75 hover:text-white">
                {SITE.email}
              </a>
            </li>
            <li className="flex items-start gap-2.5">
